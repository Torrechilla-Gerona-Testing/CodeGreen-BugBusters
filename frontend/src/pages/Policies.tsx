        ...
        <div className="flex flex-col mr-24 mb-6 w-full bg-hoverbutton p-8 rounded-xl bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-15 border border-textgreen">
          {activeSection === "protocols" && (
            <div className="text-white space-y-4 mt-2 ">
              <h1 className="font-bold text-textgreen text-2xl">
                CPU Traffic Protocol and Decorum
              </h1>

              <h1 className="whitespace-normal">
                <span className="text-textgreen font-bold mr-1">1.</span>
                All vehicle owner/drivers are required to open their windows for
                visual inspection and identification when going in and out of
                the CPU campus.
              </h1>

              <h1 className="whitespace-normal">
                <span className="text-textgreen font-bold mr-1">2.</span>
                The speed limit inside the campus is 15KPH. OVERTAKING is not
                allowed.
              </h1>

              <h1 className="whitespace-normal">
                <span className="text-textgreen font-bold mr-1">3.</span>
                All vehicles/motorcycles must park properly at designated
                parking areas. Illegal parking and Blocking of Driveway are not
                allowed. Observe No Loading/Unloading signs on designated areas.
              </h1>

              <h1 className="whitespace-normal">
                <span className="text-textgreen font-bold mr-1">4.</span>
                Blowing horns, loud noise, and blaring sounds of all
                vehicles/motorcycles are not allowed.
              </h1>

              <h1 className="whitespace-normal">
                <span className="text-textgreen font-bold mr-1">5.</span>
                All vehicles/motorcycles must follow all implementing traffic
                routes and road signs on campus.
              </h1>

              <h1>
                <span className="text-textgreen font-bold mr-1">6.</span>
                The following are not allowed inside the campus:
                <div className="ml-12 mt-2 space-y-2">
                  <h1 className="whitespace-normal">
                    <span className="text-textgreen font-bold mr-1">a.</span>
                    Smoking belching vehicles.
                  </h1>

                  <h1 className="whitespace-normal">
                    <span className="text-textgreen font-bold mr-1">b.</span>
                    Vehicles suspected of carrying bombs, dangerous chemicals or
                    contaminated by hazardous elements.
                  </h1>

                  <h1 className="whitespace-normal">
                    <span className="text-textgreen font-bold mr-1">c.</span>
                    Vehicle suspected of being used by criminal elements or used
                    for Kidnap for Ransom (KFR).
                  </h1>

                  <h1 className="whitespace-normal">
                    <span className="text-textgreen font-bold mr-1">d.</span>
              ...
              <h1 className="whitespace-normal">
                <span className="text-textgreen font-bold mr-1">7.</span>
              ...
              <h1 className="whitespace-normal">
                <span className="text-textgreen font-bold mr-1">8.</span>
              ...
              <h1 className="whitespace-normal">
                <span className="text-textgreen font-bold mr-1">9.</span>The CPU
              ...
              <h1 className="whitespace-normal">
                <span className="text-textgreen font-bold mr-1">10.</span>
                All drivers should follow CPU administrative policies,
                especially those concerning health and safety protocols.
              </h1>
            </div>
          )}
          ...
          {activeSection === "rules" && (
            <div className="text-white space-y-4 mt-2 ">
              ...
              <h1 className="whitespace-normal">
                <span className="text-textgreen font-bold mr-1">4.</span>
                Vehicles/motorcycles with car passes are given priority in
                parking areas while non-car pass vehicles are limited to only 3
                hours on parking inside the campus unless it is used for
                official purposes and sanctioned by the University
                Administration. All vehicles/motorcycles owners must follow
                10:00 PM to 5:00 AM curfew hours inside the campus.
              </h1>

              <h1 className="whitespace-normal">
                <span className="text-textgreen font-bold mr-1">5.</span>A
              ...
              <h1 className="whitespace-normal">
                <span className="text-textgreen font-bold mr-1">7.</span>
                The CPU Administration has the right to revoke parking
                privileges to any vehicle/motorcycle as necessary to protect the
                University in
                <br />
                accordance with the University standing policies for security
                and safety reasons.
              </h1>
